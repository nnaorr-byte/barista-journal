...
- **שקיפות הכרטיס:** הכרטיס שקוף-למחצה עם `backdrop-filter: blur(3px)`, כדי שפולי הקפה הנופלים ייראו מבעדו. הצפיפות היא טוקן אחד — `--card-veil` (56% בכהה, 62% בבהיר) — ולא ארבעה ערכי rgba. **המשטחים שבתוך הכרטיס נשארים אטומים** (`--bg-elevated`: אריחי סטטיסטיקה, אריחי אימות, שכבת ההתראות): הפולים נראים במרווחים של הכרטיס, לא מאחורי הטקסט. זו ההיררכיה — זכוכית מסביב, משטח מלא מתחת למספרים.
