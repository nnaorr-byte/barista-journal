...
export interface Shot {
  ...
  // ---- אמינות הרשומה ----
  // המוח סומך על היומן במאה אחוז, ולכן צריך דרך לומר לו "לא זה".
  //
  // excluded — השוט לא מייצג את הפולים האלה: מעבר פולים עם שאריות של
  // הקודמים במטחנה, ניסוי, טעות תיעוד. נשאר ביומן ומסומן, ולא נכנס לאף
  // חישוב (חלון יעד, המלצה, הזדקנות, ביקורת). הצריכה בגרמים כן נספרת —
  // הקפה הזה באמת יצא מהשקית.
  excluded?: boolean;
  excludedReason?: string;
  // choked — המכונה נחנקה: הזרימה נעצרה או ירדה לטפטוף. זמן החליטה של
  // שוט כזה חסר משמעות, ולכן גם הוא יוצא מהחישובים — אבל דרגת הטחינה
  // שלו היא המידע החשוב ביותר שיש: היא הקיר הדק של הפולים האלה.
  choked?: boolean;
